...
import 'C:/Users/ajayasr2/Desktop/Reactjs/webapp/src/index.css';
    ...
    return(
       <form onSubmit={this.submitData}>
          <div className="t1">
            ...
            <input type="text" placeholder = "Username" value={this.state.user} onChange={this.userData}></input><br></br><br></br>
            <label>Password:&nbsp;&nbsp;</label>
            <input type="password" placeholder = "password" value={this.state.pass} onChange={this.passData}></input><br></br><br></br>
            <label>Email:&nbsp;&nbsp;</label>
            <input type="email" placeholder = "email" value={this.state.email} onChange={this.mailData}></input><br></br><br></br>
            <label>Roles: &nbsp;&nbsp;</label>
            <select value = {this.state.role} onChange={this.roleData}>
                <option value="FSE">FSE</option>
                <option value="CyberSecurity">CyberSecurity</option>
                <option value="AI">AI</option>
            </select> <br></br><br></br>
            <div className="radio">
                <input type="radio" value="Male" checked={this.state.gender === "Male"} onChange={this.genderData}></input>
                <label>Male</label>
                <input type="radio" value="Female" checked={this.state.gender === "Female"} onChange={this.genderData}></input>
                <label>Female</label>
            </div>
            <br></br>
             <button type="submit">Submit</button> <br></br> </div>
